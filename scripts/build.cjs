...
const bank=C.validateQuestions(['data/v1-questions.json','data/original-questions.json','data/open-questions.json'].flatMap(read));
...
const data={version:'2026.09.20',questions:bank,resources};
