...
const C=require('../core.js');const qs=C.validateQuestions(bank.questions);assert.equal(qs.length,156);
...
const run=cp.spawnSync(process.execPath,['--test','tests/core.test.cjs','tests/app-static.test.cjs','tests/recalled.test.cjs'],{encoding:'utf8'});
